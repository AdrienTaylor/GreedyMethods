...
(1) Matlab files for generating the worst-case comparisons between the different methods 
...
(2) Files to generate the step sizes for the SSEP-based gradient method for smooth strongly
convex minimization.
